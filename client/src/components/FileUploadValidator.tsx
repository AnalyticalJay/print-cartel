        ...
        <div className="space-y-3">
          ...
          {!uploadedFileName ? (
            ...
            >
              ...
              <p className="text-gray-300 text-sm mb-3">or click to browse</p>
              <p className="text-gray-400 text-xs">
                Supported: PNG, JPG, PDF, WebP • Max 50MB
              </p>
            </div>
          ) : (
            <div className="border border-accent/50 rounded-lg p-4 bg-accent/5">
          ...
          <div className="bg-blue-900/30 border border-blue-600/50 rounded-lg p-3">
            <div className="flex gap-2">
              ...
              <div className="text-xs text-blue-200">
                <p className="font-semibold mb-1">Design Requirements:</p>
                <ul className="list-disc list-inside space-y-0.5">
                  <li>High resolution (300 DPI recommended)</li>
                  <li>Transparent background (PNG) or white background</li>
                  <li>RGB color mode (not CMYK)</li>
                  <li>Include 0.5cm bleed margin</li>
                </ul>
              </div>
            </div>
          </div>
